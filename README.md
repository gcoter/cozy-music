[![Travis build status shield](https://img.shields.io/travis/gcoter/cozy-music/master.svg)](https://travis-ci.org/gcoter/cozy-music)
[![Github Release version shield](https://img.shields.io/github/tag/gcoter/cozy-music.svg)](https://github.com/gcoter/cozy-music/releases)
...
Hacking the Cozy Music app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/gcoter/cozy-music.git
$ cd cozy-music
$ yarn install
```
...
$ docker run --rm -it -p 8080:8080 -v "$(pwd)/build":/data/cozy-app/cozy-music cozy/cozy-app-dev
or
$ yarn stack:docker
```

your app is available at http://cozy-music.cozy.tools:8080.
...
The lead maintainer for Cozy Music is [gcoter](https://github.com/gcoter), send him/her a :beers: to say hello!
...
Cozy Music is developed by gcoter and distributed under the [AGPL v3 license][agpl-3.0].
